...
<html lang="en">
    <head>
        ...
        <style>
.page-title-div {
    background-color: hsl(120, 79%, 21%);
    padding: 10px 15px;
    color: #fff;
    display: flex;
    justify-content: space-between;
    align-items: center;
    flex-wrap: wrap; /* muhiim */
    text-align: center;
}
...
.xasan {
    margin: 5px 0;
    white-space: normal; /* si uu mobile uga jabin karo */
    font-size: 22px;
}
...
<div class="row page-title-div">
    <div class="col-sm-12">
        <div  class="page-title-div">
            <div class="title-left"><h1 style="color:white;" class="cli">KOWNAYN UNIVERSITY</h1></div>
            <img class="caa" src="images/logokowneyn.jpg" alt="">
            <div class="title-right"><h1 style="color:white;" class="xasan">جامعة كونين</h1></div>
        </div>
    </div>
</div>
