<div class="left-sidebar bg-primary-500 box-shadow ">
...
<img src="images/logokowneyn.jpg" 
     ...
     alt="Logo">
                                ...
                                <h6 class="title">KOWNAYN UNIVERSITY</h6>
                                <small class="info">جامعة كونين</small>
                            </div>
                            <!-- /.user-info -->
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li class="has-children">
                                        ...
                                        <a href="#"><i class="fa fa-file-text"></i> <span>Student Semester</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
